...
interface FacialDocument extends Facial, Document {}

// Define the schema for Facial
const facialSchema = new Schema<FacialDocument>({
...
const Facial: Model<FacialDocument> = mongoose.model<FacialDocument>('Facial', facialSchema);
