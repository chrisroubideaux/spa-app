            ...
            <div className="modal-body">
              ...
              >
                ...
                <div className="card-footer d-flex text-nowrap m-auto">
                  <button className="btn btn-sm">veiw your appointment</button>
                </div>
              </div>
              {/* end of add alert */}
                  ...
                  <div className="d-flex gap-2 w-100 justify-content-between mt-1">
                    ...
                    <small className="opacity-50 text-nowrap">
                      ...
                      >
                        ...
                        <option value={massages.slot2}>{massages.slot2}</option>
                        <option value={massages.slot3}>{massages.slot3}</option>
                        <option value={massages.slot4}>{massages.slot4}</option>
                        <option value={massages.slot5}>{massages.slot5}</option>
                        <option value={massages.slot6}>{massages.slot6}</option>
                        <option value={massages.slot7}>{massages.slot7}</option>
                      </select>
                    </small>
                  </div>
                </div>
