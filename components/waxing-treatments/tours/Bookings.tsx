...
const handleSubmit = async (e: { preventDefault: () => void; }) => {
  ...
  try {
    ...
    const response = await axios.post(
      ...
      {
        waxingId: waxings._id, // Send the massage ID
                      ...
                      <div className="list-group-item list-group-item-action d-flex gap-3 py-3 ">
                        ...
                        <div className="d-flex gap-2 w-100 justify-content-between mt-1">
                          <div className="">
                            ...
                            <h6 className="">{waxings.name}</h6>
                            <h6 className="">{waxings.times}</h6>
                          </div>
                          <small className="opacity-50 text-nowrap">
                            ...
                            >
                              ...
                              <option value={waxings.slot}>
                                {waxings.slot}
                              </option>
                              <option value={waxings.slot2}>
                                {waxings.slot2}
                              </option>
                              <option value={waxings.slot3}>
                                {waxings.slot3}
                              </option>
                              <option value={waxings.slot4}>
                                {waxings.slot4}
                              </option>
                              <option value={waxings.slot5}>
                                {waxings.slot5}
                              </option>
                              <option value={waxings.slot6}>
                                {waxings.slot6}
                              </option>
                              <option value={waxings.slot7}>
                                {waxings.slot7}
                              </option>
                            </select>
                          </small>
